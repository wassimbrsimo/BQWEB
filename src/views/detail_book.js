        ...
        <View style={styles.bottom_layout}>
          ...
          <View
            ...
            <Button
              ...
              containerStyle={[
                styles.container_style_btn_play_quiz,
                {width: this.state.width / 3, height: this.state.width / 10},
              ]}
              raised={true}
              buttonStyle={[styles.play_quiz, {height: this.state.width / 10}]}
              onPress={() => {
            ...
            {this.state.book && this.state.book.Link && (
              <Button
                ...
                containerStyle={[
                  styles.container_style_btn_pic_other_book,
                  {
                    width: this.state.width / 1.4,
                    height: this.state.width / 10,
                    // marginTop:this.state.width/14,
                    // marginBottom:this.state.width/12,
                  },
                ]}
                //raised={true}
                buttonStyle={[
                  styles.pic_other_book,
                  {height: this.state.width / 10, backgroundColor: '#3db948'},
                ]}
              />
            )}
            <Button
