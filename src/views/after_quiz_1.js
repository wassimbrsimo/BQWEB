            ...
            <View style={styles.top_center}>
              ...
              <View
                ...
                <View style={styles.ranking_box}>
                  ...
                  />
                  <Text style={{fontSize: this.state.width / 24}}>Ranking</Text>
                  <Text style={{fontSize: this.state.width / 20}}>
                ...
                <View style={styles.points_box}>
                  ...
                  />
                  <Text style={{fontSize: this.state.width / 24}}>Points</Text>
                  <Text style={{fontSize: this.state.width / 20}}>
            ...
            <View
              ...
              <Text
                style={{
                  ...
                  zIndex: 1000,
                  textAlign: 'center',
                  fontSize: this.state.cloud_txt_size,
                }}>
                {this.state.text_after_quiz}
              </Text>
            </View>
